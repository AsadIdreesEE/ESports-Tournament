...
while True:
    ...
    frameTime = frame[122:212, 305:560]
    frameTeam1_name = frame[130:190, 575:765]
    frameTeam2_name = frame[130:190, 995:1175]
    frame_Score1= frame[115:210,780:1165]
    frame_Score2= frame[115:210,780:1165]
    cv2.imshow('frame',frame_Score2)
    Game_Time= pytesseract.image_to_string(frame_Score1)
