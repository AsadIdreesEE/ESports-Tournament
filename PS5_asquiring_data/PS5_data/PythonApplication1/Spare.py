...
#########################################################################
    ...
    # Showing the Scores:
        ...
        if (f.writable()==True):
        #with open('D:\\TeamData.txt', 'a') as f:
            f.write('\nR6    '+ Team1name6[:3]+'    '+Team2name6[:3]+'    '+ str(x16)+'    '+str(y10))
        #time.sleep(0.2)
...
############################################################################################################################################
    ...
    if (var[7]=='E'):
        frameTime7 = frame7[280:350, 420:615]
        frameTeam1_name7 = frame7[205:270, 230:390]
        frameTeam2_name7 = frame7[205:270, 630:815]
        frame_Score17= frame7[210:345, 440:585]
        frame_Score27= frame7[210:345, 440:585]
        #cv2.imshow('frame',frameTeam1_name)
        Game_Time7= pytesseract.image_to_string(frameTime7)
        Game_Time7=Game_Time7.rstrip('\n')
        Game_Tim7=Game_Time7+"AAA"
        Team1name7 = pytesseract.image_to_string(frameTeam1_name7)
        Team1name7=Team1name7.rstrip('\n')# removing /n to add data after
        Team1name7=Team1name7+'1___'# adding data after that in case there is nothing to read 
        Team2name7 = pytesseract.image_to_string(frameTeam2_name7)
        Team2name7=Team2name7.rstrip('\n')
        Team2name7=Team2name7+'1___'
        Score17=pytesseract.image_to_string(frame_Score17)
        Score17=Score17.rstrip('\n')# Removing /n from data 
        Score17=Score17+"AAA"
        Score27=pytesseract.image_to_string(frame_Score27)
        Score27=Score27.rstrip('\n')# Removing /n from data 
        Score27=Score27+"AAA"
    # Showing Time of the Match
        Char1_Time7= Game_Time7[:1] 
        Char2_Time7=Game_Time7[1:2] 
        Char3_Time7=Game_Time7[2:3]
        Char1_2_Time7= Game_Time7[:2] 
        if  (Char1_Time7 =='0') or (Char1_Time7 =='1') or (Char1_Time7=='2') or (Char1_Time7=='3') or (Char1_Time7=='4') or (Char1_Time7=='5') or (Char1_Time7=='6') or (Char1_Time7=='7')or (Char1_Time7=='8') or (Char1_Time7=='9'):
            if (Char2_Time7 =='0') or (Char2_Time7 =='1') or (Char2_Time7=='2') or (Char2_Time7=='3') or (Char2_Time7=='4') or (Char2_Time7=='5') or (Char2_Time7=='6') or (Char2_Time7=='7')or (Char2_Time7=='8') or (Char2_Time7=='9'):
                MatchTime7=MatchTime_prev7=int(Char1_2_Time7)
                f7=1
        else:
            MatchTime7=MatchTime_prev7
            f7=0
    # End Time of the Match
    
    #Showing the Name of the Teams
        if (Team1name7[3]!='1'):
            Team1name7= Team1name_prev7
        else:
            if (f7==1):
                Team1name_prev7=Team1name7[:3]
            else:
                Team1name7= Team1name_prev7

        if (Team2name7[3]!='1'):
            Team2name7= Team2name_prev7
        else:
            if (f7==1):
                Team2name_prev7=Team2name7[:3]
            else:
                Team2name7= Team2name_prev7
 
    # Showing the Scores:
        if (Score17[0]=='0') or (Score17[0]=='1') or (Score17[0]=='2') or (Score17[0]=='3') or (Score17[0]=='4') or (Score17[0]=='5') or (Score17[0]=='6') or (Score17[0]=='7') or (Score17[0]=='8') or (Score17[0]=='9'):
            if (int(Score17[0])<=(1+x17)):
                x17=x1p7=int(Score17[0])
        else:
            x17=x1p7
   
        if (Score27[2]=='0') or (Score27[2]=='1') or (Score27[2]=='2') or (Score27[2]=='3') or (Score27[2]=='4') or (Score27[2]=='5') or (Score27[2]=='6') or (Score27[2]=='7') or (Score27[2]=='8') or (Score27[2]=='9'):
            if (int(Score27[2])<=(1+y17)):
                y17=y1p7=int(Score27[2])
        else:
            y17=y1p7
        f= open('D:\\TeamData.txt', 'a') 
        if (f.writable()==True):
        #with open('D:\\TeamData.txt', 'a') as f:
            f.write('\nE7    '+ Team1name7[:3]+'    '+Team2name7[:3]+'    '+ str(x17)+'    '+str(y17))
        #time.sleep(0.2)
        #print ("Current Time: "+ str(MatchTime))
        
    elif (var[7]=='S'):
        frameTime7 = frame7[122:212, 305:560]
        frameTeam1_name7 = frame7[130:190, 575:765]
        frameTeam2_name7 = frame7[130:190, 995:1175]
        frame_Score17= frame7[115:210,780:1165]
        frame_Score27= frame7[115:210,780:1165]
        #cv2.imshow('frame',frame_Score10)
        Game_Time7= pytesseract.image_to_string(frameTime7)
        Game_Time7=Game_Time7.rstrip('\n')
        Game_Tim7=Game_Time7+"AAA"
    ...
    # Showing the Scores:
        ...
        if (f.writable()==True):
        #with open('D:\\TeamData.txt', 'a') as f:
            f.write('\nS7    '+ Team1name7[:3]+'    '+Team2name7[:3]+'    '+ str(x17)+'    '+str(y17))
        #time.sleep(0.2)

    ##############################################################
    elif (var[7]=='I'):
        frameTime7 = frame7[130:215, 1180:1370]
        frameTeam1_name7 = frame7[130:220, 330:540]
        frameTeam2_name7 = frame7[130:220, 930:1100]
        frame_Score17= frame7[130:210, 650:800]
        frame_Score27= frame7[130:210, 650:800]
        Game_Time7= pytesseract.image_to_string(frameTime7)
        Game_Time7=Game_Time7.rstrip('\n')
        Game_Tim7=Game_Time7+"AAA"
        Team1name7 = pytesseract.image_to_string(frameTeam1_name7)
    ...
    # Showing the Scores:
        ...
        if (f.writable()==True):
        #with open('D:\\TeamData.txt', 'a') as f:
            f.write('\nI7    '+ Team1name7[:3]+'    '+Team2name7[:3]+'    '+ str(x17)+'    '+str(y17))
        #time.sleep(0.2)

#########################################################################
    elif (var[7]=='G'):
        frameTime7 = frame7[110:180, 285:460]
        frameTeam1_name7 = frame7[110:180, 470:630]
        frameTeam2_name7 = frame7[110:180, 660:800]
        frame_Score17= frame7[185:315, 475:620]
        frame_Score27= frame7[185:315, 675:820]
        Game_Time7= pytesseract.image_to_string(frameTime7)
        Game_Time7=Game_Time7.rstrip('\n')
        Game_Time7=Game_Time7+"AAA"
        Team1name7 = pytesseract.image_to_string(frameTeam1_name7)
        Team1name7=Team1name7.rstrip('\n')# removing /n to add data after
        Team1name7=Team1name7+'1___'# adding data after that in case there is nothing to read 
        Team2name7 = pytesseract.image_to_string(frameTeam2_name7)
        Team2name7=Team2name7.rstrip('\n')
        Team2name7=Team2name7+'1___'
        Score17=pytesseract.image_to_string(frame_Score17, config=("-c tessedit"
                  "_char_whitelist=abcdefghijklmnopqrstuvwxyzABCDEFGHIJKLMNOPQRSTUVWXYZ0123456789"
                  " --psm 10"
                  " -l osd"
                  " "))
        Score17=Score17.rstrip('\n')# Removing /n from data 
        Score17=Score17+"AAA"
        Score27=pytesseract.image_to_string(frame_Score27, config=("-c tessedit"
                  "_char_whitelist=abcdefghijklmnopqrstuvwxyzABCDEFGHIJKLMNOPQRSTUVWXYZ0123456789"
                  " --psm 10"
                  " -l osd"
                  " "))
    ...
    # Showing Time of the Match
        ...
        if (Score27[0]=='0') or (Score27[0]=='1') or (Score27[0]=='2') or (Score27[0]=='3') or (Score27[0]=='4') or (Score27[0]=='5') or (Score20[0]=='6') or (Score27[0]=='7') or (Score27[0]=='8') or (Score27[0]=='9'):
            if (int(Score27[0])<=(1+y17)):
                y17=y1p7=int(Score27[0])
        elif (Score27[0]=='l'):
            if (y17<=1):
                y17=y1p7=1
        else:
        ...
        if (f.writable()==True):
        #with open('D:\\TeamData.txt', 'a') as f:
            f.write('\nG7    '+ Team1name7[:3]+'    '+Team2name7[:3]+'    '+ str(x17)+'    '+str(y17))
        #time.sleep(0.2)

    elif (var[7]=='F'):
        frameTime7 = frame7[145:240, 200:445]
        frameTeam1_name7 = frame7[145:240, 500:820]
        frameTeam2_name7 = frame7[145:240, 1210:1570]
        frame_Score17= frame7[135:245,500:950]
        frame_Score27= frame7[135:245,1100:1570]
        Game_Time7= pytesseract.image_to_string(frameTime7)
        Game_Time7=Game_Time7.rstrip('\n')
        Game_Time7=Game_Time7+"AAA"
        Team1name7 = pytesseract.image_to_string(frameTeam1_name7)
    ...
    # Time of the game
        ...
        if (Score17[-1]=='0') or (Score17[-1]=='1') or (Score17[-1]=='2') or (Score17[-1]=='3') or (Score17[-1]=='4') or (Score17[-1]=='5') or (Score17[-1]=='6') or (Score17[-1]=='7') or (Score17[-1]=='8') or (Score17[-1]=='9'):
            if (int(Score17[-1])<=(1+x17)):
                x17=x1p7=int(Score17[-1])
        ...
        if (Score27[0]=='0') or (Score27[0]=='1') or (Score27[0]=='2') or (Score27[0]=='3') or (Score27[0]=='4') or (Score27[0]=='5') or (Score27[0]=='6') or (Score27[0]=='7') or (Score27[0]=='8') or (Score27[0]=='9'):
            if (int(Score27[0])<=(1+y17)):
                y17=y1p7=int(Score27[0])
        ...
        if (f.writable()==True):
        #with open('D:\\TeamData.txt', 'a') as f:
            f.write('\nF7    '+ Team1name7[:3]+'    '+Team2name7[:3]+'    '+ str(x17)+'    '+str(y17))

        #time.sleep(0.2)

    elif (var[7]=='R'):
        frameTime7 = frame7[110:180, 200:400]
        frameTeam1_name7 = frame7[110:180, 470:640]
        frameTeam2_name7 = frame7[110:180, 850:1010]
        frame_Score17= frame7[110:180, 660:835]
        frame_Score27= frame7[110:180, 660:835]
        #cv2.imshow('frame',frameTeam1_name)
        Game_Time7= pytesseract.image_to_string(frameTime7)
        Game_Time7=Game_Time7.rstrip('\n')
        Game_Tim7=Game_Time7+"AAA"
    ...
    # Showing the Scores:
        ...
        if (f.writable()==True):
        #with open('D:\\TeamData.txt', 'a') as f:
            f.write('\nR7    '+ Team1name7[:3]+'    '+Team2name7[:3]+'    '+ str(x17)+'    '+str(y17))
        #time.sleep(0.2)
